   ...
   /***************************************************************************
    ...
    public static void htmlToWord(String html, String docFile) {    
        ...
        try {    
            ...
            Dispatch doc = Dispatch.invoke(docs, "Open", Dispatch.Method, new Object[] { "<table><tr><td>1</td><td>2</td><td>3</td></tr></table>", new Variant(false), new Variant(true) }, new int[1]).toDispatch();    
